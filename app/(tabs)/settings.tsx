    ...
    return (
        <SafeAreaView className="flex-1 bg-[#FFF5F7]">
            <ScrollView contentContainerStyle={{ paddingHorizontal: 24, paddingTop: 32, paddingBottom: 120 }}>
                <Text className="text-3xl font-balsamiq-bold text-[#FF69B4] mb-8">{t('settings.title')}</Text>
                ...
                <Text className="text-[#FF85A1] font-balsamiq-bold mb-4 ml-2 uppercase tracking-widest text-xs">
                    {t('settings.language')}
                </Text>
                ...
                >
                    ...
                    <Text className="text-[#FF69B4] font-balsamiq-bold text-lg">{t('common.logout')}</Text>
                </TouchableOpacity>

                <Text className="text-center text-[#FFB6C1] mt-8 text-xs font-balsamiq">
                    Rosie v1.0.0
                </Text>
            </ScrollView>
        </SafeAreaView>
...
const SettingItem = ({ icon, label, value, onToggle }: any) => (
    <View className="flex-row items-center justify-between">
        <View className="flex-row items-center space-x-3">
            ...
            <Text className="text-[#FF819E] font-balsamiq-bold text-base">{label}</Text>
        </View>
        <Switch
            value={value}
...
const LanguageButton = ({ label, active, onPress }: any) => (
    ...
    >
        <Text className={`font-balsamiq-bold ${active ? 'text-white' : 'text-[#FF85A1]'}`}>{label}</Text>
    </TouchableOpacity>
);
